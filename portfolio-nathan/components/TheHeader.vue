<template>
    <header :class="{ 'onScroll' : !view.topOfPage }">
        <div id="logo-nav">
            <nuxt-link to="/"><img src="../assets/img/logo/logo-nl.svg" alt="logo"></nuxt-link>
        </div>
        <ul id="links">
        ...
        <div id="nav-social">
            ...
            <nuxt-link to="/contact"><img id="envelope" src="../assets/img/icon/envelope.svg" alt="envelope"></nuxt-link>
        </div>
        <div id="burger">
            <div class="line" id="line__1"></div>
            <div class="line" id="line__2"></div>
            <div class="line" id="line__3"></div>
        </div>
        <div class="on" id="menu-phone">
