    ...
    <section id="mention">
      <div id="mention-block">
        ...
        <p>
          ...
          <br><br>
          <strong>Webmaster</strong> : Nathan Lagrange – nathanlagrange98@gmail.com<br>
          <strong>Hébergeur</strong> : Netlify – 2325 3rd Street, Suite 296 San Francisco <br>
          <strong>Délégué à la protection des données</strong> : Nathan Lagrange – nathanlagrange98@gmail.com<br>
        </p>
        <div class="sep-50" />
        <h2>II. Conditions générales d’utilisation du site et des services proposés</h2>
        <div class="sep-30" />
        <p>
        ...
        <div class="sep-30" />
        <p>Le site internet utilise la technologie VueJS / Nuxt (Javascript)</p>
        <div class="sep-30" />
        <p>
