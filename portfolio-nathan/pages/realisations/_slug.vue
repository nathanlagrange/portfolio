...
export default {
  ...
  async asyncData ({ $content, params }) {
    const article = await $content('realisations', params.slug).fetch()
    return { article }
  },
  head () {
    return {
      ...
      meta: [
        ...
        },
        {
          hid: 'og:url',
          property: 'og:url',
          content: `https://nathanlagrange.dev/realisations/${this.$route.params.slug}`
        },
        {
          hid: 'twitter:url',
          name: 'twitter:url',
      ...
      link: [
        {
          hid: 'canonical',
          rel: 'canonical',
          href: `https://nathanlagrange.dev/realisations/${this.$route.params.slug}`
        }
      ]
    }
  }
